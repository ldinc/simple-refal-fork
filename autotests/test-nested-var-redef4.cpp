...
static refalrts::FnResult lambda_Go_1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    if( ! refalrts::char_left( 'c', bb_0, be_0 ) )
      break;
    if( ! refalrts::svar_left( sF_2_1, bb_0, be_0 ) )
      break;
    if( ! refalrts::empty_seq( bb_0, be_0 ) )
      break;
#ifdef INTERPRET
    ...
    res = refalrts::splice_elem( res, n3 );
    res = refalrts::splice_stvar( res, sF_2_1 );
    res = refalrts::splice_elem( res, n2 );
    res = refalrts::splice_elem( res, n1 );
    res = refalrts::splice_elem( res, n0 );
    refalrts::use( res );
...
refalrts::FnResult Go(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    if( ! refalrts::alloc_open_call( n0 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n1 = 0;
    if( ! refalrts::alloc_name( n1, & lambda_Go_1, "lambda_Go_1" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n2 = 0;
    if( ! refalrts::alloc_open_call( n2 ) )
      return refalrts::cNoMemory;
