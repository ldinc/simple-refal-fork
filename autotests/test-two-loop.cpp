...
refalrts::FnResult Go(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    if( ! refalrts::alloc_open_bracket( n10 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n11 = 0;
    if( ! refalrts::alloc_number( n11, 2UL ) )
      return refalrts::cNoMemory;
    refalrts::Iter n12 = 0;
    ...
    if( ! refalrts::alloc_open_bracket( n26 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n27 = 0;
    if( ! refalrts::alloc_number( n27, 1UL ) )
      return refalrts::cNoMemory;
    refalrts::Iter n28 = 0;
    ...
    if( ! refalrts::alloc_open_bracket( n37 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n38 = 0;
    if( ! refalrts::alloc_number( n38, 1UL ) )
      return refalrts::cNoMemory;
    refalrts::Iter n39 = 0;
    ...
    if( ! refalrts::alloc_char( n50, 't' ) )
      return refalrts::cNoMemory;
    refalrts::Iter n51 = 0;
    if( ! refalrts::alloc_number( n51, 1UL ) )
      return refalrts::cNoMemory;
    refalrts::Iter n52 = 0;
    ...
    if( ! refalrts::alloc_char( n59, 'l' ) )
      return refalrts::cNoMemory;
    refalrts::Iter n60 = 0;
    if( ! refalrts::alloc_number( n60, 1UL ) )
      return refalrts::cNoMemory;
    refalrts::Iter n61 = 0;
    ...
    refalrts::link_brackets( n36, n62 );
    res = refalrts::splice_elem( res, n62 );
    refalrts::link_brackets( n53, n61 );
    ...
    refalrts::link_brackets( n44, n52 );
    ...
    refalrts::link_brackets( n26, n34 );
