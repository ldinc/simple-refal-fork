...
static refalrts::FnResult lambda_Test_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    static refalrts::Iter eX_3_b_1;
    static refalrts::Iter eX_3_e_1;
    // e.X#3
    eX_3_b_1 = bb_0;
    eX_3_e_1 = be_0;
#ifdef INTERPRET
    const static refalrts::ResultAction raa[] = {
      {refalrts::icSpliceEVar, & eX_3_b_1, & eX_3_e_1},
      {refalrts::icEnd}
    };
    ...
    res = refalrts::splice_evar( res, eX_3_b_1, eX_3_e_1 );
    refalrts::use( res );
...
static refalrts::FnResult lambda_Test_1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::move_right( bb_0, be_0 );
    // ( e.X#1 ) & Test
    if( ! refalrts::function_right( & Test, bb_0, be_0 ) )
      break;
    refalrts::Iter bb_1 = 0;
    refalrts::Iter be_1 = 0;
    if( ! refalrts::brackets_left( bb_1, be_1, bb_0, be_0 ) )
    ...
    refalrts::Iter res = arg_begin;
    refalrts::Iter n0 = 0;
    if( ! refalrts::alloc_name( n0, & lambda_Test_0, "lambda_Test_0" ) )
...
static refalrts::FnResult Test(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    if( ! refalrts::alloc_name( n1, & refalrts::create_closure, "refalrts::create_closure" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n2 = 0;
    if( ! refalrts::alloc_name( n2, & lambda_Test_1, "lambda_Test_1" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n3 = 0;
...
refalrts::FnResult Go(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    if( ! refalrts::alloc_open_call( n15 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n16 = 0;
    if( ! refalrts::alloc_name( n16, & Test, "Test" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n17 = 0;
    ...
    if( ! refalrts::alloc_close_call( n20 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n21 = 0;
    if( ! refalrts::alloc_name( n21, & Test, "Test" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n22 = 0;
