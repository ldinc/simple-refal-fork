...
static refalrts::FnResult WithE(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    static refalrts::Iter ePrefix_1_b_1;
    static refalrts::Iter ePrefix_1_e_1;
    static refalrts::Iter ePrefix_1_b_2;
    static refalrts::Iter ePrefix_1_e_2;
    static refalrts::Iter eSuffix_1_b_1;
    static refalrts::Iter eSuffix_1_e_1;
    static refalrts::Iter eSuffix_1_b_2;
    static refalrts::Iter eSuffix_1_e_2;
    // ( e.Prefix#1 e.Suffix#1 ) e.Prefixes_B#1 ( e.Prefix#1 ) e.Suffix#1
    ...
    do {
      ...
      eSuffix_1_b_1 = bb_4;
      eSuffix_1_e_1 = be_4;
      if( ! refalrts::repeated_evar_right( eSuffix_1_b_2, eSuffix_1_e_2, eSuffix_1_b_1, eSuffix_1_e_1, bb_3, be_3 ) )
        continue;
      refalrts::Iter bb_2 = 0;
      refalrts::Iter be_2 = 0;
      if( ! refalrts::brackets_right( bb_2, be_2, bb_3, be_3 ) )
        continue;
      if( ! refalrts::repeated_evar_left( ePrefix_1_b_2, ePrefix_1_e_2, ePrefix_1_b_1, ePrefix_1_e_1, bb_2, be_2 ) )
        continue;
      if( ! refalrts::empty_seq( bb_2, be_2 ) )
        continue;
      // Unused closed variable e.Prefixes_B#1
#ifdef INTERPRET
...
#endif
    } while ( refalrts::open_evar_advance( ePrefix_1_b_1, ePrefix_1_e_1, bb_1, be_1 ) );
  } while ( 0 );
...
refalrts::FnResult Go(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    const static refalrts::ResultAction raa[] = {
      ...
      {refalrts::icFunc, (void*) & WithE, (void*) "WithE"},
    ...
    refalrts::Iter n1 = 0;
    if( ! refalrts::alloc_name( n1, & WithE, "WithE" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n2 = 0;
    ...
    if( ! refalrts::alloc_open_call( n19 ) )
      return refalrts::cNoMemory;
    refalrts::Iter n20 = 0;
    if( ! refalrts::alloc_name( n20, & WithE, "WithE" ) )
      return refalrts::cNoMemory;
    refalrts::Iter n21 = 0;
